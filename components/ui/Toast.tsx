...
export default function Toast({ toast, onRemove }: ToastProps) {
  ...
  return (
    <div
      className={`${styles.bg} ${styles.border} ${styles.text} border rounded-lg shadow-lg p-4 mb-3 flex items-start gap-3 animate-in slide-in-from-right-full duration-300 max-w-md`}
      role="alert"
    >
