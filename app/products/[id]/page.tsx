      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl p-8 border border-slate-200 dark:border-slate-700">
          ...
          <div className="flex items-center gap-4 mb-6">
            <label className="text-slate-700 dark:text-slate-300">Quantité:</label>
            <input
              type="number"
              min="1"
              max={product.stock}
              ...
              className="w-20 px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg dark:bg-slate-700 dark:text-slate-100"
            />
          </div>
          ...
          <div className="flex gap-4 items-center">
            <button
              ...
              className="flex-1 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 disabled:bg-slate-400 disabled:cursor-not-allowed transition-colors font-medium"
            >
              Ajouter au panier
            </button>
